---
title: 보건교육용 손 세균 스캐너 Docs
---

# 🧼 보건교육용 손 세균 스캐너

초등학교 보건교육용 손 세균 스캐너 앱의 기획 및 개발 명세서입니다.
...
- **세균/이펙트 렌더링**: [[Rendering_Architecture]] · [[Germ_Display_Mode]] · [[Germ_Generation_Algorithm]] · [[Germ_Animations]] · [[Microscope_Haze_Layer]] · [[After_Mode_Effects]] · [[Pinch_Zoom_Gesture]]
- **에셋/설정**: [[Dummy_Component_Fallback]] · [[Asset_Folder_Structure]] · [[Settings_and_Persistence]]
