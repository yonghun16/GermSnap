...
- **Skia 세균 렌더링 & 제스처**: `content/03_Germ_and_Clean_Rendering.md`
- **에셋 및 개발 로드맵**: `content/04_Asset_and_Development_Guide.md`

> ⚠️ **중요 규칙**: 코드를 작성하거나 수정할 때는 반드시 위 `content/` 폴더 내의 해당 명세 문서를 먼저 참조하여 기획 의도에 맞게 코딩하세요.
...
코드는 `content/04_Asset_and_Development_Guide.md`의 **Phase 1 ~ Phase 5** 순서에 맞춰 단계별로 구현합니다.
